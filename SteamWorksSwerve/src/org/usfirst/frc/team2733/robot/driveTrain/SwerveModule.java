...
public class SwerveModule {
	...
	public SwerveModule(WheelPosition wheelPos, SwerveCalc swerveCalc) {
		...
		rotationMotor = new RotationMotor(RobotMap.rotateMotorPorts.get(wheelPos), RobotMap.rotationEncoderPorts.get(wheelPos),
				RobotMap.rotationEncoderValues.get(wheelPos)[0], RobotMap.rotationEncoderValues.get(wheelPos)[1],
				RobotMap.PRotate, RobotMap.IRotate);
