...
public class Robot extends SampleRobot {
    ...
    protected void robotInit() {
        ...
        // shooter = new ShooterAndAgitator(portConfig.getShooterPort(),
        // portConfig.getAgitatorPort());
    ...
    public void operatorControl() {
        ...
        while (isOperatorControl() && isEnabled()) {
            ...
            if (driveStation.getTrigger()) {
                ...
                double direction = (data.getDirection() > 10) ? (3 * Math.PI / 2)
                        : (data.getDirection() < -10) ? (Math.PI / 2) : 0;
                double rotation = 0;
                double gyroOffset = 0;
