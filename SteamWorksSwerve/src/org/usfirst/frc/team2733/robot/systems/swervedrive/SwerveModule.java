...
public class SwerveModule {
	 ...
	 * @param driveMotorPort Port for the drive motor
	 * @param rotationMotorPort Port for the rotation motor
	 * @param encoderPort Port for the encoder (analog potentiometer)
	 * @param wheelPos WheelPosition for this swerve module
	 * @param swerveCalc Handle to the swerveCalc for this drive train
	 * @param analogOffset Offset for the encoder
	 */
	public SwerveModule(SpeedController driveSpeedController, SpeedController rotationSpeedController, int encoderPort, WheelPosition wheelPos, SwerveCalc swerveCalc, double analogOffset) {
		PIEnum P_Coef;
		PIEnum I_Coef;
		...
		driveMotor = new DriveMotor(driveSpeedController, PIEnum.MODULE_DRIVE_P.getCoefficient(), PIEnum.MODULE_DRIVE_I.getCoefficient());
		rotationMotor = new RotationMotor(rotationSpeedController, P_Coef.getCoefficient(), I_Coef.getCoefficient(), encoderPort, analogOffset);
