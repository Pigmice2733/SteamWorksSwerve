...
public class RotationMotor {
	 ...
	 * @param motorPort Rotation motor port
	 * @param P P coefficient for PID controller
	 * @param I I coefficient for PID controller
	 * @param encoderPort Encoder port
	 * @param encoderOffset Offset for encoder
	 */
	 ...
	 * @param setAngle The angle (in radians) to turn wheel to
	 */
