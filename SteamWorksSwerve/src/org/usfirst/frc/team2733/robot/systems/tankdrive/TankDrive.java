...
public class TankDrive extends AbstractDriveTrain {
    ...
    /**
     * Creates a slave of master for each port except port number 0, adds them
     * to slaves
     * 
     * @param ports
     *            List of ports for the slaves
     * @param master
     *            CANTalon to use as the master
     * @param slaves
     *            List to hold the slaves
     */
