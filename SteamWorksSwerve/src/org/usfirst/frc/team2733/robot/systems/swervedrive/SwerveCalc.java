...
public class SwerveCalc {
    ...
    // Holds Cartesian coordinates of each wheel, origin is the center of the drive train
	private Map<WheelPosition, Tuple<Double>> wheelCoordinates = new HashMap<>();

	// The X and Y of the tuple correspond to the velocity and rotation of the wheel aims.
	private Map<WheelPosition, Tuple<Double>> wheelAims = new HashMap<>();
	
	/**
	 * SwerveCalc constructor
	 * @param wheelCoordinates The Cartesian coordinates of each wheel relative to the center of the robot
	 */
	...
	/**
	 * Swerve math
	 * @param velocityVector Vector form of the robot's desired velocity
	 * @param rotation Target rotational velocity
	 * @param centerOfRotation The center of the rotation relative to the center of the robot 
	 * @param wheelPosition The WheelPosition of the wheel to calculate for
	 */
	private void setWheelAim(Tuple<Double> velocityVector, double rotation, Tuple<Double> centerOfRotation, WheelPosition wheelPosition) {
		...
		wheelAims.put(wheelPosition, new Tuple<Double>(Math.sqrt(Math.pow(Wxi, 2) + Math.pow(Wyi, 2)), Math.atan2(Wxi, Wyi)));
	}
	 ...
	 * @param targSpeed Speed for the robot
	 * @param targAngle Target direction of motion
	 * @param currentAngle Current direction
	 * @return The optimal target direction and target speed of the robot to attain the targets
	 */
	 ...
	 * @return
	 * The velocity the given wheel should aim for
	 */
	 ...
	 * @return
	 * The rotational position the given wheel should aim for
	 */
