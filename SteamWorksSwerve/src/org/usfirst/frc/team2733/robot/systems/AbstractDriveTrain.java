...
public abstract class AbstractDriveTrain {
	...
	/**
	 * Checks if the drive train is initialized, will return false if initialization fails
	 ...
	 * @param speed Target velocity for the robot in m/s
	 * @param direction The direction for the robot to drive (relative to its current orientation) in radians
	 * @param rotation Target rotational velocity for the robot in radians/s
	 * @param gyroOffset Direction offset in radians
	 */
	 ...
	 * @param leftSpeed Target speed for left side of drive train
	 * @param rightSpeed Target speed for right side of drive train
	 * @param gyroOffset Gyro value for field-centric commands 
	 */
