...
public class OptimalAngleTest {
    ...
    public void testAngle(double startAngle, double targetAngle, double targetSpeed, double expectedAngle,
            double expectedSpeed) {
        SwerveCalc swerveCalc = new SwerveCalc(SwerveDriveTrain.getSwerveDict());

        // Target Speed doesn't matter for the test so it is always 1 (can't be
        // 0)
